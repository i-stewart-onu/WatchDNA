    ...
    Scaffold(
        ...
        if (currentDetail != null) {
            when (currentDetail) {
                ...
                "RedBar" -> RedBarScreen(Modifier.padding(padding))
                "Your Daily Routine" -> YourDailyRoutineScreen(Modifier.padding(padding))
                "World Watch Day" -> WorldWatchDayScreen(Modifier.padding(padding))
